  ...
  <form action="./quiz_create.php" method="POST">
    ...
    <div id="quizzes">
      ...
      <fieldset>
        <legend>問題3</legend>
        <div>
          <label for="quiz_3">問題文:</label>
          <input type="textarea" name="quiz_3" id="quiz_3">
        </div>
        <div>
          <label for="A_3_1">選択肢1:</label>
          <input type="text" name="A_3_1" id="A_3_1">
        </div>
        <div>
          <label for="A_3_2">選択肢2:</label>
          <input type="text" name="A_3_2" id="A_3_2">
        </div>
        <div>
          <label for="A_3_3">選択肢3:</label>
          <input type="text" name="A_2_3" id="A_2_3">
        </div>
        <div>
          <label for="A_2_4">選択肢4:</label>
